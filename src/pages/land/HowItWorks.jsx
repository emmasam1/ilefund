...
const HowItWorks = () => {
  ...
  return (
    <div className='bg-white'>
      {/* Hero Section */}
      <section className='grid grid-cols-1 sm:grid-cols-2 gap-8 items-center px-15 py-16 bg-cover bg-center bg-[url(https://res.cloudinary.com/da1mxvbx2/image/upload/v1767944328/ilefund/ilefund-land-nigeria-bg-2_fymozq.png)]'>
